...
- **Commit-message AI provider** — choose Codex or Claude Code (`better-git-vscode.commitMessageProvider`). The default `ask` detects both on first use and saves your explicit choice globally; use **Better Git: Change Commit Message AI Provider** to switch later.
